...
const Sidebar = () => {
  ...
  return (
    <div className={`overflow-y-auto no-scrollbar  h-screen text-white`}>
      <div>
        <div className={`flex items-center border-b border-[#ffffff1f] justify-center bg-[#1C2C3F] ${isOpen ? "pt-4.5" : "pt-4.25"} transition-all duration-200 ease-in-out  relative z-50`}>
          {isOpen ? (
            <Image
              src={logo}
              alt="Logo"
